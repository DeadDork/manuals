...
<title>
	C Write Text File
</title><meta name="google-site-verification" content="DQ4Zakk29CktWxh0frP4XH3xWwRu-t9qcYUZdVlhzxc" /><meta name="description" content="In this tutorial, you will learn how to write text file using standard I/O functions in C." /><meta name="keywords" content="C Write Text File" /><meta name="robots" content="index,follow" /><link href="http://cprogramminglanguage.net/App_Themes/ansiC/layout.css" type="text/css" rel="stylesheet" /></head>
<body>
    <form name="aspnetForm" method="post" action="http://cprogramminglanguage.net/_sites/cprogramminglanguage.net/c-write-text-file.aspx" id="aspnetForm">
<div>
...
<div>
	...
	<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="oFlL2m7FLE5iKHrWf7BNRzRbMxEAvLK2onUu9mqzY4k4Q6k3ObpGRlB6nIEu3vQPZU0uhwcdnJelg9EAWLjAC4sdfXE=" />
</div>
<div id="wrap">
  <div id="topnavbar">
    <div class="topnavbarleft">
<p>
        <a id="ctl00_pnlTop_Header1_LoginStatus1" href="http://cprogramminglanguage.net/login.aspx?ReturnUrl=/default.aspx?pg=0a17cf2c-5680-4d40-a982-129e1170172c" rel ="nofollow"><img src="images/loginout.png"   style="vertical-align:middle" alt="login"/></a>
    ...
    <div id="contentleft">
      <div class="postarea">
        <div class="breadcrumb"> 
              <span id="ctl00_pnlTop_sitemapPath"><span class="node"></span><span class="separator">&nbsp;&raquo;&nbsp;</span><span><a class="node" href="c-programming-language-tutorial.aspx">C Programming Language</a></span><span class="separator">&nbsp;&raquo;&nbsp;</span><span><a class="node" href="c-file.aspx">C File</a></span><span class="separator">&nbsp;&raquo;&nbsp;</span><span class="currentNode">C Write Text File</span></span>
        </div>
        <div class="clearfix"></div>
        <h1>C Write Text File</h1>
        <div class="ads_none"><div class="lqm_ad" lqm_publisher="lqm.cprogramminglanguage.site" lqm_zone="ron" lqm_format="336x280"></div></div>
        <div class="html_content"><strong>Summary</strong><em>: In this tutorial, you will learn how to write text file using standard I/O functions.</em><h2>C Write Text File Steps</h2>Here are the steps of writing strings into a text file line by line:<ul>	<li>Open the file for writing using fopen function with mode “w”. It is important to note that in this mode the file content is deleted and the file is overwritten if it exists.</li>	<li>Use function fprintf to write text into the file stream.</li>	<li>Use function fclose to close the file.</li></ul><h2>C Write Text File Source Code</h2>In the source code below we will write 10 lines of text into a text file <em>1.txt</em> in the <em>c:\temp</em> directory.</div>
        <!--INFOLINKS_OFF-->
        <pre class="brush: c">/* 
...
int main ()
{
   ...
   return 0;
        ...
        <!--INFOLINKS_ON-->
        <div class="html_content">In this tutorial, you’ve learned how to write text file using function fprintf().</div>
                ...
                <div class="readon_nav">
                    <ul>
                <li>
                    <a id="ctl00_mainContent_ctl05__relatedPageLst_ctl01_lnkPage" href="c-read-text-file.aspx">C Read Text File</a>
                </li>
                <li>
                    <a id="ctl00_mainContent_ctl05__relatedPageLst_ctl02_lnkPage" href="c-file-exists.aspx">Developing C File Exists Checking Functions</a>
                </li>
                <li>
                    <a id="ctl00_mainContent_ctl05__relatedPageLst_ctl03_lnkPage" href="http://cprogramminglanguage.net/cfileio.aspx">C File I/O</a>
                </li>
                </ul></div>
        <div style="clear:both">
        </div>
<ul id="prev_next">
    <li class="previous"> <a id="ctl00_pnlBottom_Widget2_ctl00_ctl01_PrevLink" class="grey-button pcb" href="c-read-text-file.aspx"><span>« Previous page</span></a>  </li>
    <li class="next"> <a id="ctl00_pnlBottom_Widget2_ctl00_ctl01_NextLink" class="grey-button pcb" href="c-dynamic-memory-allocation.aspx"><span>Next page »</span></a></li>
</ul>
