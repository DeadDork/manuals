...
<title>
	C Data Structures
</title><meta name="google-site-verification" content="DQ4Zakk29CktWxh0frP4XH3xWwRu-t9qcYUZdVlhzxc" /><meta name="description" content="Provides you common basic data structures such as stack, queue, lists...and other advanced data structures like tree and graphs... with clear explanation and source code examples." /><meta name="keywords" content="C data structure,data structure,c stack,c list,c queue,c tree,graph c" /><meta name="robots" content="index,follow" /><link href="http://cprogramminglanguage.net/App_Themes/ansiC/layout.css" type="text/css" rel="stylesheet" /></head>
<body>
    <form name="aspnetForm" method="post" action="http://cprogramminglanguage.net/_sites/cprogramminglanguage.net/c-data-structure.aspx" id="aspnetForm">
<div>
...
<p>
        <a id="ctl00_pnlTop_Header1_LoginStatus1" href="http://cprogramminglanguage.net/login.aspx?ReturnUrl=/default.aspx?pg=435122e5-c447-4a85-b28d-7436826940aa" rel ="nofollow"><img src="images/loginout.png"   style="vertical-align:middle" alt="login"/></a>
    ...
    <div id="contentleft">
      <div class="postarea">
        <div class="breadcrumb"> 
              <span id="ctl00_pnlTop_sitemapPath"><span class="node"></span><span class="separator">&nbsp;&raquo;&nbsp;</span><span class="currentNode">C Data Structures</span></span>
        </div>
        <div class="clearfix"></div>
        <div class="html_content"><h1> C Data Structure</h1></div>
        ...
        <ul class="subpages">
            <li class="subpage_odd">
                <h2><a href="c-stack-data-structure.aspx" title="Stack Data Structure">Stack Data Structure</a></h2>        
                <a href="c-stack-data-structure.aspx" title="Stack Data Structure">
                </a>
            ...
            <li class="subpage_even">
                <h2><a href="queue-data-structure.aspx" title="Queue">Queue</a></h2>        
                <a href="queue-data-structure.aspx" title="Queue">
                </a>
                <p>Provides the definition of queue data structure - one of the most common uses data structure in computer world. It also gives varies implementations of queue using array, link with source code.</p>
            </li>
            <li class="subpage_odd">
                <h2><a href="linked-list-data-structure-c-source-code.aspx" title="Linked List">Linked List</a></h2>        
                <a href="linked-list-data-structure-c-source-code.aspx" title="Linked List">
                </a>
                <p>Provides all common linked list data structures such as: singly-linked list, doubly-linked list,singly-circularly-linked list and Doubly-circularly-linked list with clear explanation and source code in C.</p>
            </li>
            <li class="subpage_even">
                <h2><a href="avl-tree.aspx" title="AVL Tree">AVL Tree</a></h2>        
                <a href="avl-tree.aspx" title="AVL Tree">
                </a>
                An AVL tree is a self-balancing binary search tree, and it is the first such data structure to be invented.
            </li>
            <li class="subpage_odd">
                <h2><a href="binary-search-tree-c-code.aspx" title="Binary Search Tree">Binary Search Tree</a></h2>        
                <a href="binary-search-tree-c-code.aspx" title="Binary Search Tree">
                </a>
                <p>Binary search tree (BST) is a node based binary tree data structure.</p>
            </li>
            <li class="subpage_even">
                <h2><a href="binary-heap-c-code.aspx" title="Binary Heap">Binary Heap</a></h2>        
                <a href="binary-heap-c-code.aspx" title="Binary Heap">
                </a>
                <p>A binary heap is a heap data structure created using a binary tree.</p>
            </li>
            <li class="subpage_odd">
                <h2><a href="red-black-tree-c-code.aspx" title="Red Black Tree">Red Black Tree</a></h2>        
                <a href="red-black-tree-c-code.aspx" title="Red Black Tree">
                </a>
...
<ul id="prev_next">
    <li class="previous"> <a id="ctl00_pnlBottom_Widget2_ctl00_ctl01_PrevLink" class="grey-button pcb" href="c-compilation-model-and-processes.aspx"><span>« Previous page</span></a>  </li>
    <li class="next"> <a id="ctl00_pnlBottom_Widget2_ctl00_ctl01_NextLink" class="grey-button pcb" href="c-stack-data-structure.aspx"><span>Next page »</span></a></li>
</ul>
