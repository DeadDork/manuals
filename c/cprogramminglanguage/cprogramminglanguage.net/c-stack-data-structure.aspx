...
</title><meta name="google-site-verification" content="DQ4Zakk29CktWxh0frP4XH3xWwRu-t9qcYUZdVlhzxc" /><meta name="description" content="Here you will learn what stack data structure is, how to implement a stack using C array, linked representation and applications of stack." /><meta name="keywords" content="stack,stack data structure,stack application" /><meta name="robots" content="index,follow" /><link href="http://cprogramminglanguage.net/App_Themes/ansiC/layout.css" type="text/css" rel="stylesheet" /></head>
<body>
    <form name="aspnetForm" method="post" action="http://cprogramminglanguage.net/_sites/cprogramminglanguage.net/c-stack-data-structure.aspx" id="aspnetForm">
<div>
...
<p>
        <a id="ctl00_pnlTop_Header1_LoginStatus1" href="http://cprogramminglanguage.net/login.aspx?ReturnUrl=/default.aspx?pg=b5002a16-e8eb-43af-a2db-4c62c8978fe5" rel ="nofollow"><img src="images/loginout.png"   style="vertical-align:middle" alt="login"/></a>
    ...
    <div id="contentleft">
      <div class="postarea">
        <div class="breadcrumb"> 
              <span id="ctl00_pnlTop_sitemapPath"><span class="node"></span><span class="separator">&nbsp;&raquo;&nbsp;</span><span><a class="node" href="c-data-structure.aspx">C Data Structures</a></span><span class="separator">&nbsp;&raquo;&nbsp;</span><span class="currentNode">Stack Data Structure</span></span>
        </div>
        ...
        <ul class="subpages">
            <li class="subpage_odd">
                <h2><a href="http://cprogramminglanguage.net/c-stack-source-code.aspx" title="Stack and Implementing Stack using Array">Stack and Implementing Stack using Array</a></h2>        
                <a href="http://cprogramminglanguage.net/c-stack-source-code.aspx" title="Stack and Implementing Stack using Array">
                </a>
                Stack is a data structure which works based on principle of LIFO (last in first out).
            </li>
            <li class="subpage_even">
                <h2><a href="http://cprogramminglanguage.net/stack-link-data-structure-c-source-code.aspx" title="Implementing a Stack using Link Representation">Implementing a Stack using Link Representation</a></h2>        
                <a href="http://cprogramminglanguage.net/stack-link-data-structure-c-source-code.aspx" title="Implementing a Stack using Link Representation">
                </a>
                <p>This is another version of stack data structure implemented using  link representation technique that allows the stack's size to be dynamic  and determined at run-time.</p>
            </li>
    </ul>
<div class="clearfix"></div>
...
<ul id="prev_next">
    <li class="previous"> <a id="ctl00_pnlBottom_Widget2_ctl00_ctl01_PrevLink" class="grey-button pcb" href="c-data-structure.aspx"><span>« Previous page</span></a>  </li>
    <li class="next"> <a id="ctl00_pnlBottom_Widget2_ctl00_ctl01_NextLink" class="grey-button pcb" href="http://cprogramminglanguage.net/c-stack-source-code.aspx"><span>Next page »</span></a></li>
</ul>
