...
<title>
	Step by Step download and install CodeBlocks IDE
</title><meta name="google-site-verification" content="DQ4Zakk29CktWxh0frP4XH3xWwRu-t9qcYUZdVlhzxc" /><meta name="description" content="In this tutorial, we will show you how to download CodeBlocks IDE install it into you system for programming." /><meta name="keywords" content="C IDE" /><meta name="robots" content="index,follow" /><link href="http://cprogramminglanguage.net/App_Themes/ansiC/layout.css" type="text/css" rel="stylesheet" /></head>
<body>
    <form name="aspnetForm" method="post" action="http://cprogramminglanguage.net/_sites/cprogramminglanguage.net/download-install-c-ide.aspx" id="aspnetForm">
<div>
...
<div>
	<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="/wEWAgL3yLmZDwL/lvWiBoL+EfsWqGNk0LnkGTwHmRmavtS4" />
</div>
<div id="wrap">
  <div id="topnavbar">
    <div class="topnavbarleft">
<p>
        <a id="ctl00_pnlTop_Header1_LoginStatus1" href="http://cprogramminglanguage.net/login.aspx?ReturnUrl=/default.aspx?pg=51e8e6ef-2e5e-49a1-b04f-2217ceeea175" rel ="nofollow"><img src="images/loginout.png"   style="vertical-align:middle" alt="login"/></a>
    ...
    <div id="contentleft">
      <div class="postarea">
        <div class="breadcrumb"> 
              <span id="ctl00_pnlTop_sitemapPath"><span class="node"></span><span class="separator">&nbsp;&raquo;&nbsp;</span><span><a class="node" href="c-programming-language-tutorial.aspx">C Programming Language</a></span><span class="separator">&nbsp;&raquo;&nbsp;</span><span class="currentNode">Step by Step download and install CodeBlocks IDE</span></span>
        </div>
        <div class="clearfix"></div>
        <h1>Step by Step download and install CodeBlocks IDE</h1>
        <div class="ads_none"><div class="lqm_ad" lqm_publisher="lqm.cprogramminglanguage.site" lqm_zone="ron" lqm_format="336x280"></div></div>
        <div class="html_content"><p>To start programming C, it is easier and faster if you have a good integrated development environment (IDE) to begin with.&nbsp; In this tutorial, we will show you how to download CodeBlocks IDE for C/C++ and install it in your system for programming.</p>
<h2>Introduction to CodeBlocks IDE</h2>
<p>If you are new to CodeBlocks, let&rsquo;s get into it. CodeBlocks is free, open source IDE for professional software developers. It provides all the tools and utilities needed for developing C/C++ applications.&nbsp;CodeBlocks support multiple compilers and debuggers. Its look and feel consisten across platforms such as Windows, Linux and Mac.&nbsp;Fore more details about CodeBlocks, you can go to its <a title="CodeBlocks Features" href="http://www.codeblocks.org/features">features </a>page.</p>
<h2>Download CodeBlocks</h2>
<p>To download CodeBlocks, follow the steps below:</p>
<ul>
    <li>Go to <a href="http://www.codeblocks.org/downloads">the official CodeBlocks download page</a>.</li>
    <li>Click on the <strong>download binary release</strong> link</li>
    <li>Choose your platform you are working with. We are using Windows platform.</li>
</ul>
<h2>Installing CodeBlocks</h2>
<p>The following illustrates step-by-step installing CodeBlocks for C/C++:</p>
<ul>
    <li>Double click on the download file</li>
    <li>Follow the step by step as screenshots below, click next button on each screen.</li>
    <li>Click on finish button in the last window to complete installation.</li>
</ul>
<p>Screenshots of the Installation process:</p>
<p>&nbsp;<img src="media/images/1_542x424.jpg" width="542" height="424" alt="CodeBlocks Installation Step 1" dir="&lt;not set&gt;" /></p>
<p><img src="media/images/2_542x424.jpg" width="542" height="424" alt="CodeBlocks Installation Step 2" dir="&lt;not set&gt;" /></p>
<p><img src="media/images/3_542x424.jpg" width="542" height="424" alt="CodeBlocks Installation Step 3" dir="&lt;not set&gt;" /></p>
<p><img src="media/images/4_542x424.jpg" width="542" height="424" alt="CodeBlocks Installation Step 4" dir="&lt;not set&gt;" /></p>
<p><img src="media/images/5_542x424.jpg" width="542" height="424" alt="CodeBlocks Installation Step 5" dir="&lt;not set&gt;" /></p>
<p><img src="media/images/6_542x424.jpg" width="542" height="424" alt="CodeBlocks Installation Step 6" dir="&lt;not set&gt;" /></p>
<p><img src="media/images/7_542x424.jpg" width="542" height="424" alt="CodeBlocks Installation Step 7" dir="&lt;not set&gt;" /></p>
<p>In this tutorial, we&rsquo;ve shown you step-by-step downloading, installing CodeBlocks IDE for practicing C language.</p>
<p>&nbsp;</p>
<p>&nbsp;</p></div>
        <div style="clear:both">
        </div>
<ul id="prev_next">
    <li class="previous"> <a id="ctl00_pnlBottom_Widget2_ctl00_ctl01_PrevLink" class="grey-button pcb" href="c-programming-language-tutorial.aspx"><span>« Previous page</span></a>  </li>
    <li class="next"> <a id="ctl00_pnlBottom_Widget2_ctl00_ctl01_NextLink" class="grey-button pcb" href="c-hello-world.aspx"><span>Next page »</span></a></li>
</ul>
