...
<title>
	C Compilation Model and Processes
</title><meta name="google-site-verification" content="DQ4Zakk29CktWxh0frP4XH3xWwRu-t9qcYUZdVlhzxc" /><meta name="description" content="This article outlines the basic C compilation model and processes that address those questions" /><meta name="keywords" content="C Compilation Model and Processes" /><meta name="robots" content="index,follow" /><link href="http://cprogramminglanguage.net/App_Themes/ansiC/layout.css" type="text/css" rel="stylesheet" /></head>
<body>
    <form name="aspnetForm" method="post" action="http://cprogramminglanguage.net/_sites/cprogramminglanguage.net/c-compilation-model-and-processes.aspx" id="aspnetForm">
<div>
...
<div>
	<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="/wEWAgLz9rnrAwL/lvWiBo/CLK8mICK6pY2jR0GRYkP7jQ2a" />
</div>
<div id="wrap">
  <div id="topnavbar">
    <div class="topnavbarleft">
<p>
        <a id="ctl00_pnlTop_Header1_LoginStatus1" href="http://cprogramminglanguage.net/login.aspx?ReturnUrl=/default.aspx?pg=8d8c197b-9388-4cee-8a87-2cede6358bc6" rel ="nofollow"><img src="images/loginout.png"   style="vertical-align:middle" alt="login"/></a>
    ...
    <div id="contentleft">
      <div class="postarea">
        <div class="breadcrumb"> 
              <span id="ctl00_pnlTop_sitemapPath"><span class="node"></span><span class="separator">&nbsp;&raquo;&nbsp;</span><span class="currentNode">C Compilation Model and Processes</span></span>
        </div>
        <div class="clearfix"></div>
        <h1>C Compilation Model and Processes</h1>
        <div class="ads_none"><div class="lqm_ad" lqm_publisher="lqm.cprogramminglanguage.site" lqm_zone="ron" lqm_format="336x280"></div></div>
        <div class="html_content"><p>How do you <strong>compile C</strong> code? How do you make executable program from C source code? This article outlines the basic <strong>C compilation model</strong> and processes that address those questions. You will have a better understanding of how to make executable file from C source code files.</p>
<p>The following picture illustrates the C compilation model.</p>
<p style="text-align: center; ">&nbsp;<img src="media/images/c-compilation-model_371x316.gif" width="371" height="316" title="C Compilation Model" dir="&lt;not set&gt;" alt="C Compilation Model" /></p>
<p>Let&rsquo;s examine each component in a greater detail.</p>
<ul>
    <li>The input of the C compilation process is the source code file and its result is executable file. The output of previous component is the input of the next component.</li>
    <li>The <strong>preprocessor</strong> uses source code as input.&nbsp; It is in charge of removing all the comments and interpreting preprocessor directives indicated by symbol #. For example in our &ldquo;hello word&rdquo; program, &nbsp;<em>#include</em> is used to include source of corresponding file such as standard I/O file &ldquo;<em>stdio.h&rdquo;. </em>&nbsp;The preprocessor will interpret this file in the compilation process.</li>
    <li>After preprocessor process the source, it will transfer it to the <strong>C compiler</strong>. The compiler is responsible for translating from plain source code to assembly code. We are using <strong>gcc</strong> compiler to translate C code to assembler.</li>
    <li>The <strong>assembler</strong> is in charge of creating object code. On Windows you see files with extension <strong>.obj</strong> and on UNIX the file extension is <strong><em>.o</em></strong></li>
    <li>If in the source code file, you use functions from library functions, the <strong>link editor</strong> will combine these functions with the <em>main() </em>function to make an executable file of the program. &nbsp;The link editor sometimes is referred as <strong>linker</strong>.</li>
</ul>
<p>The compilation process seems to be lengthy and require you a lot of efforts. However with a good and free IDE like <a href="http://cprogramminglanguage.net/install-netbeans-c-ide.aspx" title="Download and install CodeBlocks IDE">CodeBlocks</a>, you can configure all the components once and it will handle the tasks for you automatically with a push of button.</p>
<p>If you want to use different C compiler to make C work on your specific platform, &nbsp;you can check it out on Wikipedia, C <a rel="nofollow" href="http://en.wikipedia.org/wiki/List_of_compilers#C_compilers">compliers list</a> page.</p></div>
        <div style="clear:both">
        </div>
<ul id="prev_next">
    <li class="previous"> <a id="ctl00_pnlBottom_Widget2_ctl00_ctl01_PrevLink" class="grey-button pcb" href="c-macros.aspx"><span>« Previous page</span></a>  </li>
    <li class="next"> <a id="ctl00_pnlBottom_Widget2_ctl00_ctl01_NextLink" class="grey-button pcb" href="c-data-structure.aspx"><span>Next page »</span></a></li>
</ul>
