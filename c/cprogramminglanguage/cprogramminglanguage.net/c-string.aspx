...
<title>
	C String
</title><meta name="google-site-verification" content="DQ4Zakk29CktWxh0frP4XH3xWwRu-t9qcYUZdVlhzxc" /><meta name="description" content="C string is defined as an array of characters or a pointer to characters. Click here to learn how to use C string." /><meta name="keywords" content="c string,string in c,c string function,c string array" /><meta name="robots" content="index,follow" /><link href="http://cprogramminglanguage.net/App_Themes/ansiC/layout.css" type="text/css" rel="stylesheet" /></head>
<body>
    <form name="aspnetForm" method="post" action="http://cprogramminglanguage.net/_sites/cprogramminglanguage.net/c-string.aspx" id="aspnetForm">
<div>
...
<div>
	<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="/wEWAgL5r+zNAwL/lvWiBuPVIdr032Jz0Od2+K2iAH0Gb5k0" />
</div>
<div id="wrap">
  <div id="topnavbar">
    <div class="topnavbarleft">
<p>
        <a id="ctl00_pnlTop_Header1_LoginStatus1" href="http://cprogramminglanguage.net/login.aspx?ReturnUrl=/default.aspx?pg=90ae2de6-b9ec-45bf-ab12-a392678a78e3" rel ="nofollow"><img src="images/loginout.png"   style="vertical-align:middle" alt="login"/></a>
    ...
    <div id="contentleft">
      <div class="postarea">
        <div class="breadcrumb"> 
              <span id="ctl00_pnlTop_sitemapPath"><span class="node"></span><span class="separator">&nbsp;&raquo;&nbsp;</span><span><a class="node" href="c-programming-language-tutorial.aspx">C Programming Language</a></span><span class="separator">&nbsp;&raquo;&nbsp;</span><span class="currentNode">C String</span></span>
        </div>
        <div class="clearfix"></div>
        <div class="html_content"><h1>C String</h1></div>
        <div class="ads_none"><div class="lqm_ad" lqm_publisher="lqm.cprogramminglanguage.site" lqm_zone="ron" lqm_format="336x280"></div></div>
        <div class="html_content"><h2>String Definition</h2>
<p>C does not have a string type as other modern programming languages. C only has character type so a C string is defined as an array of characters or a pointer to characters.</p>
<h2>Null-terminated String</h2>
<p>String is terminated by a special character which is called as null terminator or null parameter (/0). So when you define a string you should be sure to have sufficient space for the null terminator. In ASCII table, the null terminator has value 0.</p>
<h2>Declaring String</h2>
<p>As in string definition, we have two ways to declare a string. The first way is, we declare an array of characters as follows:</p></div>
        <!--INFOLINKS_OFF-->
        <pre class="brush: cpp">char s[] = "string";</pre>
        <!--INFOLINKS_ON-->
    
        
        <div class="html_content"><p>And in the second way, we declare a string as a pointer point to characters:</p></div>
    
        <!--INFOLINKS_OFF-->
        <pre class="brush: cpp">char* s  = "string";</pre>
        <!--INFOLINKS_ON-->
        <div class="html_content"><p>Declaring a string in two ways looks similar but they are actually different. In the first way, you declare a string as an array of character, the size of string is 7 bytes including a null terminator. But in the second way, the compiler will allocate memory space for the string and the base address of the string is assigned to the pointer variable s.</p>
<h2>Looping Through a String</h2>
<p>You can loop through a string by using a subscript. Here is an example of looping through a string using a subscript:</p></div>
        <!--INFOLINKS_OFF-->
        <pre class="brush: cpp">// loop through a string using a subscript 
char s[] = "C string"; 
int i;
...
{ 
    printf("%c",s[i]); 
        ...
        <!--INFOLINKS_ON-->
        <div class="html_content"><p>You can also use a pointer to loop through a string. You use a char pointer and point it to the first location of the string, then you iterate it until the null terminator reached.</p></div>
        <!--INFOLINKS_OFF-->
        <pre class="brush: cpp">// loop through a string using a pointer
char* ps = s;
while(*ps != '\0'){
    printf("%c",*ps);
    ps++;
        ...
        <!--INFOLINKS_ON-->
        <div class="html_content"><h2>Passing a String to Function</h2>
<p>A formal way to pass a string to a function is passing it as a normal array.</p></div>
        <div style="clear:both">
        </div>
<ul id="prev_next">
    <li class="previous"> <a id="ctl00_pnlBottom_Widget2_ctl00_ctl01_PrevLink" class="grey-button pcb" href="c-union.aspx"><span>« Previous page</span></a>  </li>
    <li class="next"> <a id="ctl00_pnlBottom_Widget2_ctl00_ctl01_NextLink" class="grey-button pcb" href="c-file.aspx"><span>Next page »</span></a></li>
</ul>
