...
<title>
	C Comments
</title><meta name="google-site-verification" content="DQ4Zakk29CktWxh0frP4XH3xWwRu-t9qcYUZdVlhzxc" /><meta name="description" content="In this tutorial, you will learn how to use C comments to document and make your code easier to maintain" /><meta name="keywords" content="C Comments" /><meta name="robots" content="index,follow" /><link href="http://cprogramminglanguage.net/App_Themes/ansiC/layout.css" type="text/css" rel="stylesheet" /></head>
<body>
    <form name="aspnetForm" method="post" action="http://cprogramminglanguage.net/_sites/cprogramminglanguage.net/c-comments.aspx" id="aspnetForm">
<div>
...
<div>
	<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="/wEWAgLVx4WfDQL/lvWiBusJ4PdoKEha76HXTaps3z4ppExz" />
</div>
<div id="wrap">
  <div id="topnavbar">
    <div class="topnavbarleft">
<p>
        <a id="ctl00_pnlTop_Header1_LoginStatus1" href="http://cprogramminglanguage.net/login.aspx?ReturnUrl=/default.aspx?pg=1744bf7c-0f91-48c0-bbce-f94899bc21dd" rel ="nofollow"><img src="images/loginout.png"   style="vertical-align:middle" alt="login"/></a>
    ...
    <div id="contentleft">
      <div class="postarea">
        <div class="breadcrumb"> 
              <span id="ctl00_pnlTop_sitemapPath"><span class="node"></span><span class="separator">&nbsp;&raquo;&nbsp;</span><span><a class="node" href="c-programming-language-tutorial.aspx">C Programming Language</a></span><span class="separator">&nbsp;&raquo;&nbsp;</span><span class="currentNode">C Comments</span></span>
        </div>
        ...
        <div class="html_content"><p><strong>Summary</strong><em>: In this tutorial, you will learn how to use <strong>C comments</strong> to document and make your code easier to maintain.</em></p><h2>Introducing to C comments</h2><p>Comments play a very important role in your code.&nbsp; Comments help programmer explain the complex logic of the code to make it easier to maintain and enhance. C provides two types of comments are block comments and inline comments.</p><ul>    <li>Block comments begin with /* and end with &nbsp;*/</li>    <li>Inline comments begin with // and end with your comment.</li></ul><p>It is note that the inline comments were added to C language by C99 standard. Nowadays most compilers support the inline comments.</p><h2>Examples of using C comments</h2><p>We provide you several examples of using C comments in the demo program below:</p></div>
        <!--INFOLINKS_OFF-->
        <pre class="brush: c">/*
 * File:   main.c
...
int main(int argc, char** argv) {
    ...
    return 0;
        ...
        <!--INFOLINKS_ON-->
        <div class="html_content"><h2>Tips on using C comments effectively</h2><p>In order to use comments effectively you can follow the following tips:</p><ul>    <li>C comments should describe how a block of code or function does instead of telling how it works. For example, you should comment the code say &ldquo;calculate area of a circle&rdquo; instead of &ldquo;multiple of radius, radius and PI&rdquo;.</li>    <li>C comments are used to help you and other programmers to understand the piece of code in the future. Therefore when you write C comments, ask yourself if you or other can understand it by reading comments only.</li></ul><p>In this tutorial, you've learned two styles of <em><strong>C comments</strong></em> and tips how to use the C comments effectively in your code.</p></div>
        <div style="clear:both">
        </div>
<ul id="prev_next">
    <li class="previous"> <a id="ctl00_pnlBottom_Widget2_ctl00_ctl01_PrevLink" class="grey-button pcb" href="http://cprogramminglanguage.net/c-ternary-operator.aspx"><span>« Previous page</span></a>  </li>
    <li class="next"> <a id="ctl00_pnlBottom_Widget2_ctl00_ctl01_NextLink" class="grey-button pcb" href="c-control-flow.aspx"><span>Next page »</span></a></li>
</ul>
