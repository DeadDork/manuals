...
<title>
	Linked List
</title><meta name="google-site-verification" content="DQ4Zakk29CktWxh0frP4XH3xWwRu-t9qcYUZdVlhzxc" /><meta name="description" content="provides all common linked list data structures such as: singly-linked list, doubly-linked list,singly-circularly-linked list and Doubly-circularly-linked list with clear explanation and source code in C." /><meta name="keywords" content="linked list,c linked list,doubly-linked list,singly-linked list" /><meta name="robots" content="index,follow" /><link href="http://cprogramminglanguage.net/App_Themes/ansiC/layout.css" type="text/css" rel="stylesheet" /></head>
<body>
    <form name="aspnetForm" method="post" action="http://cprogramminglanguage.net/_sites/cprogramminglanguage.net/linked-list-data-structure-c-source-code.aspx" id="aspnetForm">
<div>
...
<p>
        <a id="ctl00_pnlTop_Header1_LoginStatus1" href="http://cprogramminglanguage.net/login.aspx?ReturnUrl=/default.aspx?pg=cfdc59a4-a589-434a-83b8-87b12e5d4211" rel ="nofollow"><img src="images/loginout.png"   style="vertical-align:middle" alt="login"/></a>
    ...
    <div id="contentleft">
      <div class="postarea">
        <div class="breadcrumb"> 
              <span id="ctl00_pnlTop_sitemapPath"><span class="node"></span><span class="separator">&nbsp;&raquo;&nbsp;</span><span><a class="node" href="c-data-structure.aspx">C Data Structures</a></span><span class="separator">&nbsp;&raquo;&nbsp;</span><span class="currentNode">Linked List</span></span>
        </div>
        <div class="clearfix"></div>
        <div class="html_content"><h1>Linked List</h1></div>
        ...
        <ul class="subpages">
            <li class="subpage_odd">
                <h2><a href="http://cprogramminglanguage.net/singly-linked-list-c-source-code.aspx" title="Singly-linked List">Singly-linked List</a></h2>        
                <a href="http://cprogramminglanguage.net/singly-linked-list-c-source-code.aspx" title="Singly-linked List">
                </a>
...
<ul id="prev_next">
    <li class="previous"> <a id="ctl00_pnlBottom_Widget2_ctl00_ctl01_PrevLink" class="grey-button pcb" href="http://cprogramminglanguage.net/queue.aspx"><span>« Previous page</span></a>  </li>
    <li class="next"> <a id="ctl00_pnlBottom_Widget2_ctl00_ctl01_NextLink" class="grey-button pcb" href="http://cprogramminglanguage.net/singly-linked-list-c-source-code.aspx"><span>Next page »</span></a></li>
</ul>
