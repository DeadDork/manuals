...
<title>
	C Read Text File
</title><meta name="google-site-verification" content="DQ4Zakk29CktWxh0frP4XH3xWwRu-t9qcYUZdVlhzxc" /><meta name="description" content="In this tutorial you will learn how to read text file line by line by using standard I/O functions in C." /><meta name="keywords" content="C Read Text File" /><meta name="robots" content="index,follow" /><link href="http://cprogramminglanguage.net/App_Themes/ansiC/layout.css" type="text/css" rel="stylesheet" /></head>
<body>
    <form name="aspnetForm" method="post" action="http://cprogramminglanguage.net/_sites/cprogramminglanguage.net/c-read-text-file.aspx" id="aspnetForm">
<div>
...
<div>
	...
	<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="iSTSgearBw9NcVYo5KOqYziktX+gnyP2o4KArDUfFpiIUj+Q9LbW0TAOjWOT9JfDx+rqwaCT0cWmDa0zELRf28tKId4=" />
</div>
<div id="wrap">
  <div id="topnavbar">
    <div class="topnavbarleft">
<p>
        <a id="ctl00_pnlTop_Header1_LoginStatus1" href="http://cprogramminglanguage.net/login.aspx?ReturnUrl=/default.aspx?pg=01b48e72-de24-489b-85a3-a3d610fa750e" rel ="nofollow"><img src="images/loginout.png"   style="vertical-align:middle" alt="login"/></a>
    ...
    <div id="contentleft">
      <div class="postarea">
        <div class="breadcrumb"> 
              <span id="ctl00_pnlTop_sitemapPath"><span class="node"></span><span class="separator">&nbsp;&raquo;&nbsp;</span><span><a class="node" href="c-programming-language-tutorial.aspx">C Programming Language</a></span><span class="separator">&nbsp;&raquo;&nbsp;</span><span><a class="node" href="c-file.aspx">C File</a></span><span class="separator">&nbsp;&raquo;&nbsp;</span><span class="currentNode">C Read Text File</span></span>
        </div>
        <div class="clearfix"></div>
        <h1>C Read Text File</h1>
        <div class="ads_none"><div class="lqm_ad" lqm_publisher="lqm.cprogramminglanguage.site" lqm_zone="ron" lqm_format="336x280"></div></div>
        <div class="html_content"><p><strong>Summary</strong><em>: in this tutorial you will learn how to <strong>read text file</strong> line by line by using standard I/O functions in C.</em></p><h2>C Read Text File Steps</h2><p>The step by step of reading a text files line by line as follows:</p><ul>    <li>Open the text file that need to read using <em>fopen</em> function.</li>    <li>Use function <em>fgets</em> function to read data from the stream and store it as a string. It is important to note that the newline or EOF character makes the fgets function stop reading so we can check the newline or EOF file character to read the whole line.</li>    <li>Close the file using <em>fclose</em> function.</li></ul><h2>C Read Text File Source Code</h2><p>Below is the source code of reading a text file line by line and output it to the screen.</p></div>
        <!--INFOLINKS_OFF-->
        <pre class="brush: c">/*
 * File:   main.c
...
int main() {
    ...
    return 0;
        ...
        <!--INFOLINKS_ON-->
        <div class="html_content"><p>In this tutorial, you'v learned how to read text file using standard I/O&nbsp;function in C.</p></div>
                ...
                <div class="readon_nav">
                    <ul>
                <li>
                    <a id="ctl00_mainContent_ctl05__relatedPageLst_ctl01_lnkPage" href="c-file-exists.aspx">Developing C File Exists Checking Functions</a>
                </li>
                <li>
                    <a id="ctl00_mainContent_ctl05__relatedPageLst_ctl02_lnkPage" href="http://cprogramminglanguage.net/cfileio.aspx">C File I/O</a>
                </li>
                <li>
                    <a id="ctl00_mainContent_ctl05__relatedPageLst_ctl03_lnkPage" href="c-write-text-file.aspx">C Write Text File</a>
                </li>
                </ul></div>
        <div style="clear:both">
        </div>
<ul id="prev_next">
    <li class="previous"> <a id="ctl00_pnlBottom_Widget2_ctl00_ctl01_PrevLink" class="grey-button pcb" href="c-file-exists.aspx"><span>« Previous page</span></a>  </li>
    <li class="next"> <a id="ctl00_pnlBottom_Widget2_ctl00_ctl01_NextLink" class="grey-button pcb" href="c-write-text-file.aspx"><span>Next page »</span></a></li>
</ul>
