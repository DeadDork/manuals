...
<a href="sql_func_mid.asp#" class="topnav"
...
<a target="_top" href="sql_func_mid.asp" style='font-weight:bold;'>SQL mid()</a><br />
...
SELECT MID(column_name,start[,length]) FROM table_name</div></div>
<br />
...
<table class="reference">
  ...
  <tr>
    ...
    <td valign="top">Optional. The number of characters to return. If 
	omitted, the MID() function returns the rest of the text</td>
  </tr>
  </table>
<br />
<hr />
...
<div class="code notranslate"><div>
SELECT MID(City,1,4) as SmallCity FROM Persons</div></div>
...
<a href="sql_func_mid.asp#" onclick="sharethis();return false;">Share with &raquo;</a>
</div>
</td>
</tr>
</table>
...
<a href="sql_func_mid.asp" onclick="displayError();return false">REPORT ERROR</a> |
<a href="../default.asp" target="_top">HOME</a> |
<a href="sql_func_mid.asp#top" target="_top">TOP</a> |
<a href='http://w3schools.com/sql/sql_func_mid.asp?output=print' target="_blank">PRINT</a> |
