...
<a href="sql_groupby.asp#" class="topnav"
...
<a target="_top" href="sql_groupby.asp" style='font-weight:bold;'>SQL Group By</a><br />
...
<div class="code notranslate"><div>
SELECT Customer,SUM(OrderPrice) FROM Orders</div></div>
...
<p><b>Explanation of why the above SELECT statement cannot be used:</b> The SELECT statement above has two columns specified (Customer and SUM(OrderPrice). 
The &quot;SUM(OrderPrice)&quot; returns a single value (that is the total sum of the &quot;OrderPrice&quot; column), while &quot;Customer&quot; returns 6 values 
(one value for each row in the &quot;Orders&quot; table). This will therefore not give us the correct result. However, you have seen that the GROUP BY statement solves this problem.</p>
<hr />
...
GROUP BY Customer,OrderDate</div></div>
<br />
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_func_sum.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_having.asp">Next Chapter &raquo;</a></div>
...
<a href="sql_groupby.asp#" onclick="sharethis();return false;">Share with &raquo;</a>
</div>
</td>
</tr>
</table>
...
<a href="sql_groupby.asp" onclick="displayError();return false">REPORT ERROR</a> |
<a href="../default.asp" target="_top">HOME</a> |
<a href="sql_groupby.asp#top" target="_top">TOP</a> |
<a href='http://w3schools.com/sql/sql_groupby.asp?output=print' target="_blank">PRINT</a> |
