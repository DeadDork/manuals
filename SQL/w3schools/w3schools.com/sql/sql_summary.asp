...
<a href="sql_summary.asp#" class="topnav"
...
<a target="_top" href="sql_summary.asp" style='font-weight:bold;'>SQL Summary</a><br />
<br />
...
<h1>You Have Learned SQL, <span class="color_h1">Now What?</span></h1>
<div class="chapter">
...
<hr />
<h2>SQL Summary</h2>
<p>This SQL tutorial has taught you the standard computer language for accessing and manipulating database systems.</p>
<p>You have learned how to execute queries, retrieve data, insert new records, delete records and update records in a database with SQL.</p>
<p>You have also learned how to create databases, tables, and indexes with SQL, and how to drop them.</p>
<p>You have learned the most important aggregate functions in SQL.</p>
<p>You now know that SQL is the standard language that works with all the well-known database systems like MS SQL Server, IBM DB2, Oracle, MySQL, and MS Access.</p>
<hr />

<h2>Now You Know SQL, What's Next?</h2>
<p>Our recommendation is to learn about ADO or PHP MySQL.</p>
<p>If you want to learn more about ADO, please visit our <a href="http://w3schools.com/ado/default.asp">ADO tutorial</a>.</p>
<p>If you want to learn more about MySQL, please visit our <a href="../php/default.asp">PHP tutorial</a>.</p>
<br />
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_hosting.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_quiz.asp">Next Chapter &raquo;</a></div>
...
<a href="sql_summary.asp#" onclick="sharethis();return false;">Share with &raquo;</a>
</div>
</td>
</tr>
</table>
...
<a href="sql_summary.asp" onclick="displayError();return false">REPORT ERROR</a> |
<a href="../default.asp" target="_top">HOME</a> |
<a href="sql_summary.asp#top" target="_top">TOP</a> |
<a href='http://w3schools.com/sql/sql_summary.asp?output=print' target="_blank">PRINT</a> |
