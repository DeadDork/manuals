...
<a href="sql_func_avg.asp#" class="topnav"
...
<a target="_top" href="sql_func_avg.asp" style='font-weight:bold;'>SQL avg()</a><br />
...
<div class="next"><a class="chapter" href="http://w3schools.com/sql/sql_func_count.asp">Next Chapter &raquo;</a></div>
</div>
<hr />
...
<div class="code notranslate"><div>
SELECT AVG(OrderPrice) AS OrderAverage FROM Orders</div></div>
...
WHERE OrderPrice&gt;(SELECT AVG(OrderPrice) FROM Orders)</div></div>
...
<a href="sql_func_avg.asp#" onclick="sharethis();return false;">Share with &raquo;</a>
</div>
</td>
</tr>
</table>
...
<a href="sql_func_avg.asp" onclick="displayError();return false">REPORT ERROR</a> |
<a href="../default.asp" target="_top">HOME</a> |
<a href="sql_func_avg.asp#top" target="_top">TOP</a> |
<a href='http://w3schools.com/sql/sql_func_avg.asp?output=print' target="_blank">PRINT</a> |
