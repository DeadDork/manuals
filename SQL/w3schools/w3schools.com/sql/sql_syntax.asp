...
<a href="sql_syntax.asp#" class="topnav"
...
<a target="_top" href="sql_syntax.asp" style='font-weight:bold;'>SQL Syntax</a><br />
...
<p>
The table above contains three records (one for each person) and five columns (P_Id, LastName, FirstName, Address, and City).</p>
<hr />
...
<p>The DDL part of SQL permits database tables to be created or deleted. It also defines indexes (keys), specifies links between tables, and imposes constraints between tables.
The most important DDL statements in SQL are:</p>
<ul>
...
<a href="sql_syntax.asp#" onclick="sharethis();return false;">Share with &raquo;</a>
</div>
</td>
</tr>
</table>
...
<a href="sql_syntax.asp" onclick="displayError();return false">REPORT ERROR</a> |
<a href="../default.asp" target="_top">HOME</a> |
<a href="sql_syntax.asp#top" target="_top">TOP</a> |
<a href='http://w3schools.com/sql/sql_syntax.asp?output=print' target="_blank">PRINT</a> |
