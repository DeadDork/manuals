...
<a href="sql_dates.asp#" class="topnav"
...
<a target="_top" href="sql_dates.asp" style='font-weight:bold;'>SQL Dates</a><br />
...
<hr />
<h2>SQL Dates</h2>
<p><img src="lamp.gif" alt="Note" /> The most difficult part when working with dates is to be sure that the format of the date you are trying to insert,
...
<tr>
<th width="22%" align="left">Function</th>
<th width="78%" align="left">Description</th>
</tr>
<tr>
<td><a href="http://w3schools.com/sql/func_now.asp">NOW()</a></td>
<td>Returns the current date and time</td>
</tr>
<tr>
<td><a href="http://w3schools.com/sql/func_curdate.asp">CURDATE()</a></td>
<td>Returns the current date</td>
</tr>
<tr>
<td><a href="http://w3schools.com/sql/func_curtime.asp">CURTIME()</a></td>
<td>Returns the current time</td>
</tr>
<tr>
<td><a href="http://w3schools.com/sql/func_date.asp">DATE()</a></td>
<td>Extracts the date part of a date or date/time expression</td>
</tr>
<tr>
<td><a href="http://w3schools.com/sql/func_extract.asp">EXTRACT()</a></td>
<td>Returns a single part of a date/time</td>
</tr>
<tr>
<td><a href="http://w3schools.com/sql/func_date_add.asp">DATE_ADD()</a></td>
<td>Adds a specified time interval to a date</td>
</tr>
<tr>
<td><a href="http://w3schools.com/sql/func_date_sub.asp">DATE_SUB()</a></td>
<td>Subtracts a specified time interval from a date</td>
</tr>
<tr>
<td><a href="http://w3schools.com/sql/func_datediff_mysql.asp">DATEDIFF()</a></td>
<td>Returns the number of days between two dates</td>
</tr>
<tr>
<td><a href="http://w3schools.com/sql/func_date_format.asp">DATE_FORMAT()</a></td>
...
<tr>
<td><a href="http://w3schools.com/sql/func_getdate.asp">GETDATE()</a></td>
<td>Returns the current date and time</td>
</tr>
<tr>
<td><a href="http://w3schools.com/sql/func_datepart.asp">DATEPART()</a></td>
<td>Returns a single part of a date/time</td>
</tr>
<tr>
<td><a href="http://w3schools.com/sql/func_dateadd.asp">DATEADD()</a></td>
<td>Adds or subtracts a specified time interval from a date</td>
</tr>
<tr>
<td><a href="http://w3schools.com/sql/func_datediff.asp">DATEDIFF()</a></td>
<td>Returns the time between two dates</td>
</tr>
<tr>
<td><a href="http://w3schools.com/sql/func_convert.asp">CONVERT()</a></td>
<td>Displays date/time data in different formats</td>
</tr>
</table>
<br />
...
<p><img src="lamp.gif" alt="Note" /> You can compare two dates easily if there is no time component involved!</p>
<p>Assume we have the following &quot;Orders&quot; table:</p>
<table class="reference">
<tr>
<th width="20%" align="left">OrderId</th>
<th width="45%" align="left">ProductName</th>
<th width="35%" align="left">OrderDate</th>
</tr>
<tr>
<td>1</td>
<td>Geitost</td>
...
<a href="sql_dates.asp#" onclick="sharethis();return false;">Share with &raquo;</a>
</div>
</td>
</tr>
</table>
...
<a href="sql_dates.asp" onclick="displayError();return false">REPORT ERROR</a> |
<a href="../default.asp" target="_top">HOME</a> |
<a href="sql_dates.asp#top" target="_top">TOP</a> |
<a href='http://w3schools.com/sql/sql_dates.asp?output=print' target="_blank">PRINT</a> |
