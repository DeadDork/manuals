...
<a href="sql_where.asp#" class="topnav"
...
<a target="_top" href="sql_where.asp" style='font-weight:bold;'>SQL Where</a><br />
...
FROM table_name<br />
WHERE column_name operator value</div></div>
<br />
<hr />
...
<p>However, numeric values should not be enclosed in quotes.</p>

<p>For text values:</p>

<div class="code notranslate"><div>
This is correct:<br /><br />
SELECT * FROM Persons WHERE FirstName='Tove'<br /><br />
This is wrong:<br /><br />
SELECT * FROM Persons WHERE FirstName=Tove</div></div>

<p>For numeric values:</p>
<div class="code notranslate"><div>
This is correct:<br /><br />
SELECT * FROM Persons WHERE Year=1965<br /><br />
This is wrong:<br /><br />
SELECT * FROM Persons WHERE Year='1965'</div></div>
<br />
<hr />
...
<p>
<b>Note:</b> In some versions of SQL the &lt;&gt; operator may be written as !=</p>
<br />
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_distinct.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_and_or.asp">Next Chapter &raquo;</a></div>
...
<a href="sql_where.asp#" onclick="sharethis();return false;">Share with &raquo;</a>
</div>
</td>
</tr>
</table>
...
<a href="sql_where.asp" onclick="displayError();return false">REPORT ERROR</a> |
<a href="../default.asp" target="_top">HOME</a> |
<a href="sql_where.asp#top" target="_top">TOP</a> |
<a href='http://w3schools.com/sql/sql_where.asp?output=print' target="_blank">PRINT</a> |
