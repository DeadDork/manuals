...
<a href="sql_autoincrement.asp#" class="topnav"
...
<a target="_top" href="sql_autoincrement.asp" style='font-weight:bold;'>SQL Increment</a><br />
...
<p>To insert a new record into the &quot;Persons&quot; table, we will not have to specify a value for the &quot;P_Id&quot;
...
<p>To insert a new record into the &quot;Persons&quot; table, we will not have to specify a value for the &quot;P_Id&quot; column (a unique value will be added 
automatically):</p>
...
<div class="code notranslate"><div>
INSERT INTO Persons (P_Id,FirstName,LastName)<br />
VALUES (seq_person.nextval,'Lars','Monsen')</div></div>

<p>The SQL statement above would insert a new record into the &quot;Persons&quot; table. The &quot;P_Id&quot; column would be assigned the next number from the seq_person 
...
<a href="sql_autoincrement.asp#" onclick="sharethis();return false;">Share with &raquo;</a>
</div>
</td>
</tr>
</table>
...
<a href="sql_autoincrement.asp" onclick="displayError();return false">REPORT ERROR</a> |
<a href="../default.asp" target="_top">HOME</a> |
<a href="sql_autoincrement.asp#top" target="_top">TOP</a> |
<a href='http://w3schools.com/sql/sql_autoincrement.asp?output=print' target="_blank">PRINT</a> |
