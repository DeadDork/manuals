...
<a href="sql_and_or.asp#" class="topnav"
...
<a target="_top" href="sql_and_or.asp" style='font-weight:bold;'>SQL And &amp; Or</a><br />
...
<hr />
<p class="intro">The AND &amp; OR operators are used to filter records based on more than one condition.</p>
<hr />
...
<p>Now we want to select only the persons with the last name equal to &quot;Svendson&quot; 
AND the first name equal to &quot;Tove&quot; OR to &quot;Ola&quot;:</p>
<p>We use the following SELECT statement:</p>

<div class="code notranslate"><div>
SELECT * FROM Persons WHERE<br />
LastName='Svendson'<br />
AND (FirstName='Tove' OR FirstName='Ola')</div></div>
...
<a href="sql_and_or.asp#" onclick="sharethis();return false;">Share with &raquo;</a>
</div>
</td>
</tr>
</table>
...
<a href="sql_and_or.asp" onclick="displayError();return false">REPORT ERROR</a> |
<a href="../default.asp" target="_top">HOME</a> |
<a href="sql_and_or.asp#top" target="_top">TOP</a> |
<a href='http://w3schools.com/sql/sql_and_or.asp?output=print' target="_blank">PRINT</a> |
