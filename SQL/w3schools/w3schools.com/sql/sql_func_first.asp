...
<a href="sql_func_first.asp#" class="topnav"
...
<a target="_top" href="sql_func_first.asp" style='font-weight:bold;'>SQL first()</a><br />
...
<div class="chapter">
<div class="prev"><a class="chapter" href="http://w3schools.com/sql/sql_func_count.asp">&laquo; Previous</a></div>
...
<div class="code notranslate"><div>
SELECT FIRST(OrderPrice) AS FirstOrderPrice FROM Orders</div></div>

<p><img src="lamp.gif" alt="Note" /> <b>Tip:</b> Workaround if FIRST() function is not supported:</p>
<div class="code notranslate"><div>
SELECT OrderPrice FROM Orders ORDER BY O_Id LIMIT 1</div></div>
...
<a href="sql_func_first.asp#" onclick="sharethis();return false;">Share with &raquo;</a>
</div>
</td>
</tr>
</table>
...
<a href="sql_func_first.asp" onclick="displayError();return false">REPORT ERROR</a> |
<a href="../default.asp" target="_top">HOME</a> |
<a href="sql_func_first.asp#top" target="_top">TOP</a> |
<a href='http://w3schools.com/sql/sql_func_first.asp?output=print' target="_blank">PRINT</a> |
