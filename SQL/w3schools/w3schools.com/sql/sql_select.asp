...
<a href="sql_select.asp#" class="topnav"
...
<a target="_top" href="sql_select.asp" style='font-weight:bold;'>SQL Select</a><br />
...
<hr />
<p class="intro">This chapter will explain the SELECT and the SELECT * statements.</p>
<hr />
...
FROM table_name</div></div>

<p>and</p>

<div class="code notranslate"><div>
SELECT * FROM table_name</div></div>

<p><img src="lamp.gif" alt="Note" /> <b>Note:</b> SQL is not case sensitive. SELECT is the same as select.</p>
<hr />
...
<div class="code notranslate"><div>
SELECT LastName,FirstName FROM Persons</div></div>
...
<div class="code notranslate"><div>
SELECT * FROM Persons</div></div>

<p><b>Tip:</b> The asterisk (*) is a quick way of selecting all columns!</p>
<p>The result-set will look like this:</p>
<table class="reference">
  <tr>
    <th align="left">P_Id</th>
...
<p>Most database software systems allow navigation in the result-set with programming functions, like: Move-To-First-Record,
...
please visit our <a href="http://w3schools.com/ado/default.asp">ADO tutorial</a> or our <a href="../php/default.asp">PHP tutorial</a>.</p>
<br />
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_syntax.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_distinct.asp">Next Chapter &raquo;</a></div>
...
<a href="sql_select.asp#" onclick="sharethis();return false;">Share with &raquo;</a>
</div>
</td>
</tr>
</table>
...
<a href="sql_select.asp" onclick="displayError();return false">REPORT ERROR</a> |
<a href="../default.asp" target="_top">HOME</a> |
<a href="sql_select.asp#top" target="_top">TOP</a> |
<a href='http://w3schools.com/sql/sql_select.asp?output=print' target="_blank">PRINT</a> |
