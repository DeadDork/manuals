...
<a href="sql_join.asp#" class="topnav"
...
<a target="_top" href="sql_join.asp" style='font-weight:bold;'>SQL Joins</a><br />
...
<hr />
<p class="intro">SQL joins are used to query data from two or more tables, based on a relationship between certain columns in these tables.</p>
<hr />
...
<p>A primary key is a column (or a combination of columns) with a unique value for each row. Each primary key value must be unique within 
the table. The purpose is to bind data together, across tables, without repeating all of the data in every table.</p>
...
<p>Note that the &quot;P_Id&quot; column is the primary key in the &quot;Persons&quot; table. This means that <b>no</b> two rows can have the same P_Id. The 
P_Id distinguishes two persons even if they have the same name.</p>
...
<p>Note that the &quot;O_Id&quot; column is the primary key in the &quot;Orders&quot; table and that the &quot;P_Id&quot; column refers to the
...
<ul>
	<li><b>JOIN</b>: Return rows when there is at least one match in both tables</li>
	<li><b>LEFT JOIN</b>: Return all rows from the left table, even if there are no matches in the right table</li>
	<li><b>RIGHT JOIN</b>: Return all rows from the right table, even if there are no matches in the left table</li>
	<li><b>FULL JOIN</b>: Return rows when there is a match in one of the tables</li>
</ul>
<br />
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_alias.asp">&laquo; Previous</a></div>
...
<a href="sql_join.asp#" onclick="sharethis();return false;">Share with &raquo;</a>
</div>
</td>
</tr>
</table>
...
<a href="sql_join.asp" onclick="displayError();return false">REPORT ERROR</a> |
<a href="../default.asp" target="_top">HOME</a> |
<a href="sql_join.asp#top" target="_top">TOP</a> |
<a href='http://w3schools.com/sql/sql_join.asp?output=print' target="_blank">PRINT</a> |
