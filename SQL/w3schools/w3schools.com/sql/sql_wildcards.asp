...
<a href="sql_wildcards.asp#" class="topnav"
...
<a target="_top" href="sql_wildcards.asp" style='font-weight:bold;'>SQL Wildcards</a><br />
...
<hr />
<p class="intro">SQL wildcards can be used when searching for data in a database.</p>
<hr />
...
<p>Now we want to select the persons with a first name that starts with any character, followed by &quot;la&quot; 
from the &quot;Persons&quot; table.</p>
<p>We use the following SELECT statement:</p>

<div class="code notranslate"><div>
SELECT * FROM Persons<br />
WHERE FirstName LIKE '_la'</div></div>
...
<p>Next, we want to select the persons with a last name that starts with &quot;S&quot;, 
followed by any character, followed by &quot;end&quot;, followed by any character, 
followed by &quot;on&quot; from the &quot;Persons&quot; table.</p>
<p>We use the following SELECT statement:</p>

<div class="code notranslate"><div>
SELECT * FROM Persons<br />
WHERE LastName LIKE 'S_end_on'</div></div>
...
<p>Now we want to select the persons with a last name that starts with &quot;b&quot; or &quot;s&quot; or &quot;p&quot; 
from the &quot;Persons&quot; table.</p>
<p>We use the following SELECT statement:</p>

<div class="code notranslate"><div>
SELECT * FROM Persons<br />
WHERE LastName LIKE '[bsp]%'</div></div>
...
<p>Next, we want to select the persons with a last name that do not start with 
&quot;b&quot; or &quot;s&quot; or &quot;p&quot; from the &quot;Persons&quot; table.</p>
<p>We use the following SELECT statement:</p>
...
<a href="sql_wildcards.asp#" onclick="sharethis();return false;">Share with &raquo;</a>
</div>
</td>
</tr>
</table>
...
<a href="sql_wildcards.asp" onclick="displayError();return false">REPORT ERROR</a> |
<a href="../default.asp" target="_top">HOME</a> |
<a href="sql_wildcards.asp#top" target="_top">TOP</a> |
<a href='http://w3schools.com/sql/sql_wildcards.asp?output=print' target="_blank">PRINT</a> |
