...
<a href="sql_tryit.asp#" class="topnav"
...
<a target="_top" href="sql_tryit.asp" style='font-weight:bold;'>SQL Try It</a><br />
<br />
...
<h1>SQL <span class="color_h1">Try It</span></h1>
<div class="chapter">
...
<p>We will use the <b>Customers</b> table in the Northwind database:</p>
...
SELECT * FROM customers</div></div>
<br />

<div class="code notranslate"><div>
SELECT CompanyName, ContactName FROM customers</div></div>
<br />

<div class="code notranslate"><div>
SELECT * FROM customers WHERE companyname LIKE 'a%'</div></div>
<br />

<div class="code notranslate"><div>
SELECT CompanyName, ContactName<br />
FROM customers<br />
WHERE CompanyName &gt; 'a'</div></div>

<p><img src="lamp.gif" width="15" height="15"> When using SQL on text data, &quot;alfred&quot; is greater than &quot;a&quot; (like in a dictionary).</p>

<div class="code notranslate"><div>
SELECT CompanyName, ContactName<br />
FROM customers<br />
WHERE CompanyName &gt; 'g'<br />
AND ContactName &gt; 'g'</div></div>
<br />

<form target="_blank" method="post" action="http://w3schools.com/sql/trysql.asp">
<textarea name="sql" cols="50" rows="10">
...
<a href="sql_tryit.asp#" onclick="sharethis();return false;">Share with &raquo;</a>
</div>
</td>
</tr>
</table>
...
<a href="sql_tryit.asp" onclick="displayError();return false">REPORT ERROR</a> |
<a href="../default.asp" target="_top">HOME</a> |
<a href="sql_tryit.asp#top" target="_top">TOP</a> |
<a href='http://w3schools.com/sql/sql_tryit.asp?output=print' target="_blank">PRINT</a> |
