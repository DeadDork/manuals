...
<a href="sql_union.asp#" class="topnav"
...
<a target="_top" href="sql_union.asp" style='font-weight:bold;'>SQL Union</a><br />
...
<hr />
<p class="intro">The SQL UNION operator combines two or more SELECT statements.</p>
<hr />

<h2>The SQL UNION Operator</h2>
<p>The UNION operator is used to combine the result-set of two or more SELECT statements.</p>
<p>Notice that each SELECT statement within the UNION must have the same number of columns. 
The columns must also have similar data types. Also, the columns in each SELECT statement must be in the same order.</p>

<h3>SQL UNION Syntax</h3>
<div class="code notranslate"><div>
SELECT column_name(s) FROM table_name1<br />
UNION<br />
SELECT column_name(s) FROM table_name2</div></div>

<p><b>Note:</b> The UNION operator selects only distinct values by default. To allow duplicate values, use UNION ALL.</p>
...
<p><b>PS:</b> The column names in the result-set of a UNION are always equal to the column names in the first SELECT statement in the UNION.</p>
<hr />
...
<table class="reference" style="width:60%">
  <tr>
    <th width="25%" align="left">E_ID</th>
    <th width="35%" align="left">E_Name</th>
  </tr>
  <tr>
    <td>01</td>
    <td>Hansen, Ola</td>
...
<p>Now we want to list <b>all the different</b> employees in Norway and USA.</p>
<p>We use the following SELECT statement:</p>

<div class="code notranslate"><div>
SELECT E_Name FROM Employees_Norway<br />
UNION<br />
SELECT E_Name FROM Employees_USA</div></div>

<p>The result-set will look like this:</p>
<table class="reference" style="width:60%">
  <tr>
    <th width="35%" align="left"><b>E_Name</b></th>
  </tr>
  <tr>
    <td>Hansen, Ola</td>
  </tr>
...
<p><b>Note:</b> This command cannot be used to list all employees in Norway and 
USA. In the example above we have two employees with equal names, and only one 
of them will be listed. The UNION command selects only distinct values.</p>
<hr />

<h2>SQL UNION ALL Example</h2>
<p>Now we want to list <b>all</b> employees in Norway and USA:</p>
...
<a href="sql_union.asp#" onclick="sharethis();return false;">Share with &raquo;</a>
</div>
</td>
</tr>
</table>
...
<a href="sql_union.asp" onclick="displayError();return false">REPORT ERROR</a> |
<a href="../default.asp" target="_top">HOME</a> |
<a href="sql_union.asp#top" target="_top">TOP</a> |
<a href='http://w3schools.com/sql/sql_union.asp?output=print' target="_blank">PRINT</a> |
