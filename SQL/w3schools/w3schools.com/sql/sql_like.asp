...
<a href="sql_like.asp#" class="topnav"
...
<a target="_top" href="sql_like.asp" style='font-weight:bold;'>SQL Like</a><br />
...
<hr />
<p class="intro">The LIKE operator is used in a WHERE clause to search for a specified pattern in a column.</p>
<hr />
...
FROM table_name<br />
WHERE column_name LIKE pattern</div></div>
<br />
<hr />
...
<p>It is also possible to select the persons living in a city that does NOT contain the pattern &quot;tav&quot; 
from the &quot;Persons&quot; table, by using the NOT keyword.</p>
<p>We use the following SELECT statement:</p>

<div class="code notranslate"><div>
SELECT * FROM Persons<br />
WHERE City NOT LIKE '%tav%'</div></div>
...
<a href="sql_like.asp#" onclick="sharethis();return false;">Share with &raquo;</a>
</div>
</td>
</tr>
</table>
...
<a href="sql_like.asp" onclick="displayError();return false">REPORT ERROR</a> |
<a href="../default.asp" target="_top">HOME</a> |
<a href="sql_like.asp#top" target="_top">TOP</a> |
<a href='http://w3schools.com/sql/sql_like.asp?output=print' target="_blank">PRINT</a> |
