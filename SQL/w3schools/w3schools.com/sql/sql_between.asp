...
<a href="sql_between.asp#" class="topnav"
...
<a target="_top" href="sql_between.asp" style='font-weight:bold;'>SQL Between</a><br />
...
<hr />
<p class="intro">The BETWEEN operator is used in a WHERE clause to select a range of data between two values.</p>
<hr />
...
BETWEEN value1 AND value2</div></div>
<br />
<hr />
...
WHERE LastName<br />
BETWEEN 'Hansen' AND 'Pettersen'</div></div>
...
<p><b>Note:</b> The BETWEEN operator is treated differently in different 
databases!</p>
<p>In some databases, persons with the LastName of &quot;Hansen&quot; or &quot;Pettersen&quot; will not be listed, because the BETWEEN 
operator only selects fields that are between and excluding the test values.</p>
<p>In other databases, persons with the LastName of &quot;Hansen&quot; or &quot;Pettersen&quot; will be listed, because the BETWEEN 
operator selects fields that are between and including the test values.</p>
<p>And in other databases, persons with the LastName of &quot;Hansen&quot; will be listed, but &quot;Pettersen&quot; will not be listed 
...
SELECT * FROM Persons<br />
WHERE LastName<br />
NOT BETWEEN 'Hansen' AND 'Pettersen'</div></div>
...
<a href="sql_between.asp#" onclick="sharethis();return false;">Share with &raquo;</a>
</div>
</td>
</tr>
</table>
...
<a href="sql_between.asp" onclick="displayError();return false">REPORT ERROR</a> |
<a href="../default.asp" target="_top">HOME</a> |
<a href="sql_between.asp#top" target="_top">TOP</a> |
<a href='http://w3schools.com/sql/sql_between.asp?output=print' target="_blank">PRINT</a> |
