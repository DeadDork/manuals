...
<title>SQL FULL JOIN Keyword</title>
...
<a href="sql_join_full.asp#" class="topnav"
...
<a target="_top" href="sql_join_full.asp" style='font-weight:bold;'>SQL Full Join</a><br />
...
<h1>SQL <span class="color_h1">FULL JOIN</span> Keyword</h1>
<div class="chapter">
...
ON table_name1.column_name=table_name2.column_name</div></div>
<br />
<hr />
...
ORDER BY Persons.LastName</div></div>
...
<p>The FULL JOIN keyword returns all the rows from the left table (Persons), and all the rows from the right table (Orders). If there are rows in
...
<a href="sql_join_full.asp#" onclick="sharethis();return false;">Share with &raquo;</a>
</div>
</td>
</tr>
</table>
...
<a href="sql_join_full.asp" onclick="displayError();return false">REPORT ERROR</a> |
<a href="../default.asp" target="_top">HOME</a> |
<a href="sql_join_full.asp#top" target="_top">TOP</a> |
<a href='http://w3schools.com/sql/sql_join_full.asp?output=print' target="_blank">PRINT</a> |
