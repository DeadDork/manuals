...
<a href="sql_hosting.asp#" class="topnav"
...
<a target="_top" href="sql_hosting.asp" style='font-weight:bold;'>SQL Hosting</a><br />
...
<div class="next"><a class="chapter" href="sql_summary.asp">Next Chapter &raquo;</a></div>
</div>
<hr />
<h2>SQL Hosting</h2>
<p>If you want your web site to be able to store and display data from a database, your web server should have access to a database system that uses the SQL language.</p>
<p>If your web server will be hosted by an Internet Service Provider (ISP), you will have to look for SQL hosting plans.</p>
<p>The most common SQL hosting databases are MySQL, MS SQL Server, and MS Access.</p>
<p>You can have SQL databases on both Windows and Linux/UNIX operating systems.</p>
<p>Below is an overview of which database system that runs on which OS.</p>

<p><b>MS SQL Server</b></p>
<p>Runs only on Windows OS.</p>

<p><b>MySQL</b></p>
<p>Runs on Windows, Mac OS X, and Linux/UNIX operating systems.</p>

<p><b>MS Access</b> (recommended only for small websites)</p>
<p>Runs only on Windows OS.</p>

<p>To learn more about web hosting, please visit our <a href="http://w3schools.com/hosting/default.asp">Hosting tutorial</a>.</p>
<br />
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_quickref.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_summary.asp">Next Chapter &raquo;</a></div>
...
<a href="sql_hosting.asp#" onclick="sharethis();return false;">Share with &raquo;</a>
</div>
</td>
</tr>
</table>
...
<a href="sql_hosting.asp" onclick="displayError();return false">REPORT ERROR</a> |
<a href="../default.asp" target="_top">HOME</a> |
<a href="sql_hosting.asp#top" target="_top">TOP</a> |
<a href='http://w3schools.com/sql/sql_hosting.asp?output=print' target="_blank">PRINT</a> |
