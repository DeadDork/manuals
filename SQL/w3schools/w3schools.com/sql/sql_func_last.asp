...
<a href="sql_func_last.asp#" class="topnav"
...
<a target="_top" href="sql_func_last.asp" style='font-weight:bold;'>SQL last()</a><br />
...
<div class="code notranslate"><div>
SELECT LAST(OrderPrice) AS LastOrderPrice FROM Orders</div></div>

<p><img src="lamp.gif" alt="Note" /> <b>Tip:</b> Workaround if LAST() function is not supported:</p>
<div class="code notranslate"><div>
SELECT OrderPrice FROM Orders ORDER BY O_Id DESC LIMIT 1</div></div>
...
<a href="sql_func_last.asp#" onclick="sharethis();return false;">Share with &raquo;</a>
</div>
</td>
</tr>
</table>
...
<a href="sql_func_last.asp" onclick="displayError();return false">REPORT ERROR</a> |
<a href="../default.asp" target="_top">HOME</a> |
<a href="sql_func_last.asp#top" target="_top">TOP</a> |
<a href='http://w3schools.com/sql/sql_func_last.asp?output=print' target="_blank">PRINT</a> |
